...
const About = () => {
  return (
   ...
   <div className="container">
    ...
    gap-[50px] lg:gap-[130px] xl:gap-0 flex-col
    lg:flex-row">
        ...
        order-1 lg:order-2">
            ...
            <p className='text__para'>
                For 30 years in a row, U.S. News & world Report
                has recognized us as one of the best public hospitals in the Nation and
                #1 in Texas.
            </p>
