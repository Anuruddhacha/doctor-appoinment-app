...
const DoctorCard = ({doctor}) => {
  ...
  return (
    <div className='p-3 lg:p-5'>
          ...
          lg:text-[26px] lg:leading-9 text-headingColor
          font-[700] lg:mt-5'>{name}</h2>

          <div className='mt-2 lg:mt-4 flex items-center justify-between'>
           <span className='bg-[#CCF0F3] text-irisBlueColor
           py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 
           ...
           leading-6 lg:text-[16px] lg:leading-7'>
          ...
          justify-between'>
           ...
           <div>
             <h3
             className='text-[16px] leading-7 lg:text-[18px]
             lg:leading-[30px] font-semibold
             text-headingColor'
             >{totalPatients} Patients</h3>
             <p
             className='text-[14px] leading-6 fomt-[400]
             text-textColor'
             >{hospital}</p>
           </div>
