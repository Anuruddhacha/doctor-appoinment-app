       ...
       <div className="grid md:grid-cols-3 gap-[50px]">
           ...
           <div className="flex items-center gap-5">
             ...
             <div>
              ...
              py-1 px-6 lg:py-2 lg_px-6 text-[12px]
              leading-4 lg:text-[16px] lg:leading-7
              font-semibold rounded'>
               Surgeon
              </span>
              <h3 className='text-headingColor text-[22px]
              leading-9 mt-3 font-bold'>Muhibur Rahman</h3>
               <div className="flex items-center gap-[6px]">
                <span className='flex items-center gap-[6px]
                text-[14px] leading-5 lg:text-[16px]
               ...
               <p
               className='text__para text-[14px]
               leading-5 md:text-[15px] lg:max-w-[390px]'
               >Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro dolor eveniet libero aliquam ut unde quo et odio sequi, minus, sunt labore atque consequatur itaque voluptatibus sapiente id. A, obcaecati</p>
